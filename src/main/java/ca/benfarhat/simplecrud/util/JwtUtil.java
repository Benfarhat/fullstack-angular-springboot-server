package ca.benfarhat.simplecrud.util;
...
/**
 * 
 * JwtUtil: Utilitaire / bean, pour le traitement des tokens (creation, extraction du contenu et validation)
 * 
...
public class JwtUtil {
    ...
    private static final int JWT_TTL = 1000 * 60 * 60 * 10;
